...
class AppTheme {
  ...
  static ThemeData create(ThemeVariant variant) {
    ...
    return ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        errorStyle: AppTypography.bodySRegular.copyWith(color: colors.error),
  ...
  static CupertinoThemeData createCupertino(ThemeVariant variant) {
    ...
    return CupertinoThemeData(
      ...
      textTheme: CupertinoTextThemeData(
        primaryColor: colors.accent,
        textStyle: AppTypography.bodyMRegular.copyWith(
          color: colors.textPrimary,
        ),
        actionTextStyle: AppTypography.bodyLMedium.copyWith(
          color: colors.accent,
        ),
        tabLabelTextStyle: AppTypography.headingXXS,
        navTitleTextStyle: AppTypography.headingS.copyWith(
          color: colors.textPrimary,
        ),
        navLargeTitleTextStyle: AppTypography.headingL.copyWith(
          color: colors.textPrimary,
        ),
        pickerTextStyle: AppTypography.bodyMRegular.copyWith(
          color: colors.textPrimary,
        ),
        dateTimePickerTextStyle: AppTypography.bodyMRegular.copyWith(
          color: colors.textPrimary,
        ),
      ),
    );
  ...
  static TextTheme _createTextTheme(AppColorScheme colors) {
    return TextTheme(
      ...
      headlineMedium: AppTypography.headingM.copyWith(
        color: colors.textPrimary,
      ),
      ...
      bodyMedium: AppTypography.bodyMRegular.copyWith(
        color: colors.textPrimary,
      ),
      ...
      labelMedium: AppTypography.bodyMMedium.copyWith(
        color: colors.textPrimary,
      ),
